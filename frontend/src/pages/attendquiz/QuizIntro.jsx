...
const QuizIntro = ({
  ...
  const handleFormSubmit = (e) => {
    ...
    startQuiz({
      ...
      quiz_code: studentDetails?.quiz_code,
      ...
      {currentSection === "hero" && (
        <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
          <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-6 sm:p-8 transform transition-all duration-300 hover:shadow-2xl">
            ...
            <br />
            <p className="text-sm text-gray-600 mb-2 text-center">
              This quiz is hosted by <strong>Prof Sanjoy Ghosh</strong>
            </p>
            <button
              onClick={() => setCurrentSection("form")}
              className="w-full bg-blue-500 text-white py-3 rounded-lg hover:bg-blue-600 transition-colors duration-200 flex items-center justify-center text-sm font-medium mt-2 cursor-pointer"
            >
              See Now
        ...
        <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
          <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-6 sm:p-8">
            ...
            <form onSubmit={handleFormSubmit} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-blue-500 text-white py-3 rounded-lg hover:bg-blue-600 transition-colors duration-200 text-sm font-medium cursor-pointer"
              >
                Submit
              </button>
            </form>
