            ...
            <div className="pt-2">
              ...
              <div className="flex gap-4">
                <a
                  href="#"
                  aria-label="YouTube"
                  className="bg-gray-100 hover:bg-gradient-to-br hover:from-red-600 hover:to-red-400 p-3 rounded-full transition-all duration-300 text-gray-500 hover:text-white"
                >
                  <YouTubeIcon />
                </a>
                <a
                  href="#"
                  aria-label="Facebook"
                  className="bg-gray-100 hover:bg-blue-600 p-3 rounded-full transition-all duration-300 text-gray-500 hover:text-white"
                >
                  <FacebookIcon />
                </a>
                <a
                  href="#"
                  aria-label="Twitter"
                  className="bg-gray-100 hover:bg-blue-400 p-3 rounded-full transition-all duration-300 text-gray-500 hover:text-white"
                >
                  <TwitterIcon />
                </a>
                <a
                  ...
                  className="bg-gray-100 hover:bg-gradient-to-br hover:from-purple-600 hover:to-pink-500 p-3 rounded-full transition-all duration-300 text-gray-500 hover:text-white"
                >
                  <InstagramIcon />
                </a>
                <a
                  href="#"
                  aria-label="LinkedIn"
                  className="bg-gray-100 hover:bg-blue-700 p-3 rounded-full transition-all duration-300 text-gray-500 hover:text-white"
                >
                  <LinkedinIcon />
                </a>
              </div>
